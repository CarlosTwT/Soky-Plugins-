...
async function writeExif(media, metadata) {
    ...
    if (Object.keys(metadata).length != 0) {
        const img = new webp.Image()
        const opt = { 
          packId: metadata?.packId ? metadata.packId : "https://github.com/CarlosTwT", 
          packName: metadata?.packName ? metadata.packName : "Sticker By", 
          packPublish: metadata?.packPublish ? metadata.packPublish : "© c4rl0s_9e",
          packEmail: metadata?.packEmail ? metadata.packEmail : "carlos.e.escobarmc@gmail.com", 
          packWebsite: metadata?.packWebsite ? metadata.packWebsite : "https://github.com/CarlosTwT", 
